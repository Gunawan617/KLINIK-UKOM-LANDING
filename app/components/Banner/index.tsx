...
const Banner = () => {
  ...
  useEffect(() => {
    const fetchTeamMembers = async () => {
      try {
        const res = await fetch(getApiUrl(API_CONFIG.ENDPOINTS.TEAM_MEMBERS), {
          cache: "no-store",
        });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-6 gap-y-12">
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col gap-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6 justify-center lg:justify-start">
              <Link
                href="https://wa.me/6281295012668?text=Halo%20Klinik%20UKOM,%20saya%20mau%20konsultasi%20bimbingan%20UKOM"
                target="_blank"
