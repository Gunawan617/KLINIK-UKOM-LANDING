...
//                       </Link>
//                     </h2>
//                     <p className="text-gray-600">{truncateText(post.summary, 120)}</p>
...
//           {/* Artikel Terbaru */}
//           <div>
//             <h3 className="font-bold text-lg mb-3">Artikel Terbaru</h3>
...
//           {/* Artikel Populer */}
//           <div>
//             <h3 className="font-bold text-lg mb-3">Artikel Populer</h3>
//             <ul className="space-y-3">
...
//           {/* Tag */}
//           <div>
//             <h3 className="font-bold text-lg mb-3">Tag</h3>
//             <div className="flex flex-wrap gap-2">
//               {tags.map((tag) => (
//                 <Link
//                   key={tag.id}
//                   href={`/tag/${tag.slug}`}
//                   className="px-3 py-1 bg-gray-200 rounded-full text-sm hover:bg-blue-600 hover:text-white"
//                 >
//                   {tag.name}
//                 </Link>
//               ))}
